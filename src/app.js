...
function renderIngredientsBoard() {
  document.getElementById("patty-item").style.display = state.Patty ? "block" : "none";
  document.getElementById("cheese-item").style.display = state.Cheese ? "block" : "none";
  document.getElementById("tomato-item").style.display = state.Tomatoes ? "block" : "none";
  document.getElementById("onion-item").style.display = state.Onions ? "block" : "none";
  document.getElementById("lettuce-item").style.display = state.Lettuce ? "block" : "none";
}
